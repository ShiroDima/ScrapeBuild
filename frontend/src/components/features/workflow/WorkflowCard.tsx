...
const WorkflowCard: React.FC<WorkflowCardProps> = ({workflow}) => {
    ...
    return (
        <Card className="border border-separate shadow-sm rounded-lg overflow-hidden border-shadow-md dark:shadow-primary/30">
            <CardContent className="p-4 flex items-center justify-between h-[100px]">
                <div className="flex items-center justify-end space-x-3">
                    ...
                    <div>
                            ...
                            {isDraft && (
                                <span className="ml-2 px-2 py-0.5 text-xs font0-medium bg-yellow-100 text-yellow-800 rounded-full">Draft</span>
                            )}
                        </h3>
                    </div>
                </div>
